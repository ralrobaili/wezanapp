...
extension Color {
    ...
    static let wTint1   = Color(adaptive: "#EDE9FF", dark: "#252244")
    static let wTint2   = Color(adaptive: "#F3F1FF", dark: "#1E1B38")

    static let wBg      = Color(adaptive: "#F2F2F7", dark: "#0C0C1A")
    static let wBgBase  = Color(adaptive: "#FFFFFF", dark: "#111128")
    ...
    static let wLabel        = Color(adaptive: "#1C1C1E", dark: "#F2F2F7")
    ...
    static let wLow    = Color(adaptive: "#FF3B30", dark: "#FF453A")
    static let wHigh   = Color(adaptive: "#FF9500", dark: "#FF9F0A")
    static let wNormal = Color(adaptive: "#34C759", dark: "#30D158")
    static let wBlue   = Color(adaptive: "#007AFF", dark: "#0A84FF")
